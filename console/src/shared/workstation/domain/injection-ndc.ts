import type { InjectionMedicationKey } from "./injection-catalog.js";
...
export const BUNDLED_INJECTION_NDC_OPTIONS: readonly NdcPackageOption[] = [
  ...packageOptions(
    ...
    "441 mg/1.6 mL",
    "prefilled syringe",
    "1 syringe in 1 carton",
    "Alkermes, Inc.",
    ["65757-401-03", { ndc: "65757-401-04", packageKind: "sample" }],
  ),
  ...packageOptions(
    "aristada",
    "662 mg",
    ...
    "1 syringe in 1 carton",
    "Alkermes, Inc.",
    ["65757-402-03", { ndc: "65757-402-04", packageKind: "sample" }],
  ),
  ...packageOptions(
    "aristada",
    "882 mg",
    ...
    "1 syringe in 1 carton",
    "Alkermes, Inc.",
    ["65757-403-03", { ndc: "65757-403-04", packageKind: "sample" }],
  ),
  ...packageOptions(
    "aristada",
    "1064 mg",
    ...
    "1 syringe in 1 carton",
    "Alkermes, Inc.",
    ["65757-404-03", { ndc: "65757-404-04", packageKind: "sample" }],
  ),
  ...packageOptions(
    "initio",
    "675 mg",
    ...
    "1 syringe in 1 carton",
    "Alkermes, Inc.",
    ["65757-500-03", { ndc: "65757-500-04", packageKind: "sample" }],
  ),
  ...packageOptions(
    "sustenna",
    "39 mg",
  ...
  ...packageOptions(
    ...
    "1 prefilled syringe in 1 kit",
    "Janssen Pharmaceuticals, Inc.",
    ["50458-563-01", { ndc: "50458-563-03", packageKind: "sample" }],
  ),
  ...packageOptions(
    "sustenna",
    "234 mg",
    ...
    "1 prefilled syringe in 1 kit",
    "Janssen Pharmaceuticals, Inc.",
    ["50458-564-01", { ndc: "50458-564-03", packageKind: "sample" }],
  ),
  ...packageOptions(
    "erzofri",
    "39 mg",
    ...
    "1 glass prefilled syringe in 1 kit",
  ...
  ...packageOptions(
    ...
    "1 glass prefilled syringe in 1 kit",
    "Shandong Luye Pharmaceutical Co., Ltd.",
    ["72526-110-11", { ndc: "72526-110-21", packageKind: "sample" }],
  ),
  ...packageOptions(
    "trinza",
    "273 mg",
  ...
  ...packageOptions(
    ...
    "50 mg",
    "50 mg/0.14 mL",
    "extended-release glass syringe",
    "1 glass prefilled syringe in 1 carton",
    "Teva Pharmaceuticals USA, Inc.",
    ["51759-305-10", { ndc: "51759-305-11", packageKind: "sample" }],
  ),
  ...packageOptions(
    "uzedy",
    "75 mg",
    ...
    "1 glass prefilled syringe in 1 carton",
    "Teva Pharmaceuticals USA, Inc.",
    ["51759-410-10", { ndc: "51759-410-11", packageKind: "sample" }],
  ),
  ...packageOptions(
    "uzedy",
    "100 mg",
    ...
    "1 glass prefilled syringe in 1 carton",
    "Teva Pharmaceuticals USA, Inc.",
    ["51759-520-10", { ndc: "51759-520-11", packageKind: "sample" }],
  ),
  ...packageOptions(
    "uzedy",
    "125 mg",
    ...
    "1 glass prefilled syringe in 1 carton",
    "Teva Pharmaceuticals USA, Inc.",
    ["51759-630-10", { ndc: "51759-630-11", packageKind: "sample" }],
  ),
  ...packageOptions(
    "uzedy",
    "150 mg",
    ...
    "1 glass prefilled syringe in 1 carton",
    "Teva Pharmaceuticals USA, Inc.",
    ["51759-740-10", { ndc: "51759-740-11", packageKind: "sample" }],
  ),
  ...packageOptions(
    "uzedy",
    "200 mg",
    ...
    "1 glass prefilled syringe in 1 carton",
    "Teva Pharmaceuticals USA, Inc.",
    ["51759-850-10", { ndc: "51759-850-11", packageKind: "sample" }],
  ),
  ...packageOptions(
    "uzedy",
    "250 mg",
    ...
    "1 glass prefilled syringe in 1 carton",
    "Teva Pharmaceuticals USA, Inc.",
    ["51759-960-10", { ndc: "51759-960-11", packageKind: "sample" }],
  ),
  ...packageOptions(
    "maintena",
    "300 mg",
    ...
    "1 prefilled dual-chamber syringe in 1 kit",
  ...
  ...packageOptions(
    ...
    "1 prefilled dual-chamber syringe in 1 kit",
    "Otsuka America Pharmaceutical, Inc.",
    ["59148-072-80", { ndc: "59148-072-92", packageKind: "sample" }],
  ),
  ...packageOptions(
    "maintena",
    "300 mg",
  ...
  ...packageOptions(
    ...
    "1 syringe in 1 carton",
    "Otsuka America Pharmaceutical, Inc.",
    ["59148-114-80", { ndc: "59148-114-92", packageKind: "sample" }],
  ),
  ...packageOptions(
    "vivitrol",
    "380 mg",
    "380 mg/vial",
    "single-dose kit",
    "1 vial, diluent, and administration supplies in 1 kit",
    "Alkermes, Inc.",
    ["65757-300-01", { ndc: "65757-301-01", packageKind: "sample" }],
  ),
...
const matchesKnownNdc = (
  candidate: NdcPackageOption,
  digits: string,
): boolean =>
  ndcDigits(candidate.ndc) === digits ||
  (EXPLICIT_NDC_ALIASES[candidate.ndc] ?? []).some(
    (alias) => ndcDigits(alias) === digits,
  );

const isCatalogMedication = (
  medicationKey: InjectionMedicationKey | "",
): medicationKey is NdcCatalogMedicationKey =>
...
export const resolveNdcOptions = (
  ...
  const applicable = all.filter(
    (option) =>
      !option.dose || !requestedDose || doseKey(option.dose) === requestedDose,
  );
  ...
  for (const option of applicable) {
    ...
    if (!deduped.has(key) || option.source === "bundled")
...
export const buildFdaNdcDirectoryUrl = (
  query: NdcOptionQuery,
): string | undefined => {
...
const packageKindFrom = (value: unknown): NdcPackageKind =>
  value === true || asText(value).toLocaleLowerCase() === "true"
    ? "sample"
    : "commercial";

const matchingBundledDose = (
  query: NdcOptionQuery,
  productNdc: string,
): string | undefined => {
...
const productMatchesDose = (
  query: NdcOptionQuery,
  product: FdaNdcProduct,
): boolean => {
  ...
  return asArray<FdaNdcIngredient>(product.active_ingredients).some(
    (ingredient) => doseKey(asText(ingredient.strength)).startsWith(requested),
  );
};
...
export const fdaNdcOptionsFromPayload = (
  ...
  if (!isCatalogMedication(query.medicationKey)) return [];
  const products = asArray<FdaNdcProduct>(
    (payload as FdaNdcPayload | null)?.results,
  );
  ...
  for (const product of products) {
    ...
    const productNdc = asText(product.product_ndc);
    const dose =
      matchingBundledDose(query, productNdc) || query.dose || undefined;
    const strength =
  ...
  return resolveNdcOptions(query, options).filter(
    (option) => option.source === "remote",
  );
};
...
export type FdaNdcDirectoryFetcher = (
  query: Readonly<NdcOptionQuery>,
) => Promise<unknown>;

export interface NdcOptionsLookup {
  options: NdcPackageOption[];
  remoteStatus:
    "not-applicable" | "bundled" | "cached" | "refreshed" | "fallback";
  checkedAt?: string;
}
...
const optionFromCache = (
  ...
  if (
    !value ||
    typeof value !== "object" ||
    !isCatalogMedication(query.medicationKey)
  )
    return undefined;
  ...
  if (
    !ndc ||
    raw.medicationKey !== query.medicationKey ||
    raw.source !== "remote"
  )
    return undefined;
  const requested = doseKey(query.dose);
  if (raw.dose && requested && doseKey(raw.dose) !== requested)
    return undefined;
  return {
...
const browserReferenceStorage = (): NdcReferenceStorage | null => {
  try {
    const candidate =
      ...
      (globalThis as { localStorage?: NdcReferenceStorage }).localStorage;
...
export const fetchFdaNdcDirectory: FdaNdcDirectoryFetcher = async (query) => {
  ...
  if (!response.ok)
    throw new Error(`FDA NDC directory request failed (${response.status}).`);
...
export const createNdcOptionResolver = (
  ...
  const storage =
    options.storage === undefined ? browserReferenceStorage() : options.storage;
  ...
  const lookup = (query: NdcOptionQuery): NdcOptionsLookup => {
    ...
    return isFresh(entry)
      ? fromCache(
          query,
          entry,
          entry?.outcome === "failed" ? "fallback" : "cached",
        )
  ...
  const refreshIfStale = async (
    ...
    if (isFresh(current)) {
      return fromCache(
        query,
        current,
        current?.outcome === "failed" ? "fallback" : "cached",
      );
    }
    const key = queryCacheKey(query);
    const attempted = attemptedAt.get(key);
    if (attempted !== undefined && now() - attempted < ttlMs)
      return lookup(query);
