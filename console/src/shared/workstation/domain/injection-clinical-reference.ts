...
export type InjectionClinicalPhase =
  "maintenance" | "initiation" | "reinitiation" | "loading" | "prn";
...
export type InjectionTechniquePhase =
  "preparation" | "needle" | "mechanics" | "aftercare";
...
const fact = (
  ...
  statement: string,
  source: ClinicalReferenceSource,
): InjectionClinicalReferenceFact => ({
  id,
  classification,
  statement,
  source,
    ...
    medications: {
      aristada: {
        ...
        knowledge: {
          ...
          preparation:
            "Prefilled syringe; prepare and inspect according to the current product instructions.",
          ...
          needleRules: [
            {
              ...
              rationale:
                "Longer of the two supplied deltoid needles for greater tissue depth.",
            },
            {
              siteGroups: ["deltoid"],
              doses: ["441 mg"],
              ...
              rationale:
                "Supplied deltoid needle options for the 441 mg strength.",
            },
            {
              siteGroups: ["gluteal"],
              habitus: ["larger"],
              ...
              rationale:
                "Longer of the two supplied gluteal needles for greater tissue depth.",
            },
            {
              siteGroups: ["gluteal"],
              needle: { gauge: "20G", length: '1½"' },
      ...
      initio: {
        ...
        catalog: {
          ...
          verificationRequirements: {
            maintenance: ["resuspend"],
            initiation: ["resuspend"],
            reinitiation: ["resuspend"],
          },
          verificationDetails: {
            resuspend: verificationDetail(
          ...
          missedDoseGuidance:
            "One-time initiation component; follow the active initiation plan.",
          siteGuidance: "all-im",
        },
        ...
        knowledge: {
          ...
          staffGuardrail:
            "Not a maintenance dose. Document it only with the active initiation/re-initiation plan.",
        },
        administration: {
          needleRules: [
            {
      ...
      sustenna: {
        ...
        knowledge: {
          ...
          technique:
            "Use the kit needle and preparation steps appropriate to the selected site and current label.",
          preparation:
            "Prefilled syringe; inspect and prepare per current product instructions.",
          storage: "Use current carton and label storage instructions.",
          staffGuardrail:
            "Initiation/re-initiation checks are needed only when that phase is documented; routine maintenance still requires order, product, and administration verification.",
        },
        administration: {
          ...
          needleRules: [
            ...
            },
            {
              ...
              needle: { gauge: "22G", length: '1½"' },
              rationale:
                "Gluteal administration, regardless of patient weight.",
            },
          ],
          needleUnresolved:
      ...
      erzofri: {
        ...
        knowledge: {
          className: "Atypical antipsychotic LAI (monthly)",
          technique:
            "Use the product kit and current label preparation instructions; initial 351 mg is deltoid only.",
          preparation:
            "Prefilled syringe; inspect and prepare per current product instructions.",
          storage: "Use current carton and label storage instructions.",
          staffGuardrail:
            "351 mg is not a routine maintenance selection. Maintenance 39-234 mg is a distinct monthly pathway.",
        },
        administration: {
          needleRules: [
            {
      ...
      trinza: {
        ...
        catalog: {
          ...
          windowAfter: 14,
          cadenceByInterval: {
            q12wk: { kind: "days", days: 84, label: "every 3 months" },
          },
        ...
        knowledge: {
          ...
          technique:
            "Use the product kit and the current site-specific preparation instructions.",
          preparation:
            "Prefilled syringe; inspect and prepare per current product instructions.",
          storage: "Use current carton and label storage instructions.",
          staffGuardrail:
            "Calendar cadence is a scheduling aid. Transition, re-initiation, and missed-dose decisions remain provider/product-table review.",
        },
        administration: {
      ...
      hafyera: {
        ...
        catalog: {
          ...
          windowAfter: 21,
          cadenceByInterval: {
            q26wk: { kind: "days", days: 182, label: "every 6 months" },
          },
          verifications: ["resuspend", "stabilized"],
          verificationRequirements: {
            maintenance: ["resuspend"],
        ...
        knowledge: {
          ...
          technique:
            "Use the product kit and current gluteal administration instructions.",
          preparation:
            "Prefilled syringe; inspect and prepare per current product instructions.",
          storage: "Use current carton and label storage instructions.",
          staffGuardrail:
          ...
          needleRules: [
            {
              ...
              rationale:
                "Supplied gluteal needle; this product is gluteal only.",
            },
          ],
          needleUnresolved: "",
          angle: IM_ANGLE,
      ...
      uzedy: {
        ...
        knowledge: {
          ...
          technique:
            "Use the supplied device and current label site/preparation instructions.",
          preparation:
            "Prefilled syringe; inspect and prepare per current product instructions.",
          storage: "Use current carton and label storage instructions.",
          staffGuardrail:
            "Once-monthly and every-2-month regimens use distinct strengths. Verify the active order before documenting a late or missed dose.",
        },
        administration: {
          needleRules: [
            {
              ...
              needle: {
                gauge: "21G",
                length: '5⁄8"',
                descriptor: "attached to prefilled syringe",
              },
              rationale:
                "Needle is supplied attached to the single-dose prefilled syringe.",
            },
          ],
          needleUnresolved: "",
          siteRestriction: {
      ...
      maintena: {
        ...
        knowledge: {
          className: "Atypical antipsychotic LAI (monthly)",
          technique:
            "Use the ordered presentation and current label preparation/site instructions.",
          preparation:
            "Prepare the selected vial or prefilled presentation according to current product instructions.",
          storage: "Use current carton and label storage instructions.",
          staffGuardrail:
            "Document an oral/one-day pathway only when this encounter is initiation or re-initiation; verify timing and restart decisions against the active order.",
        },
        administration: {
      ...
      asimtufii: {
        ...
        knowledge: {
          ...
          technique:
            "Use the supplied syringe and current gluteal preparation instructions; do not massage after injection.",
          preparation:
            "Prefilled syringe; inspect and prepare per current product instructions.",
          storage: "Use current carton and label storage instructions.",
          staffGuardrail:
            "Gluteal-only and no-massage checks apply to every administration. Tolerability/transition review applies to initiation or re-initiation.",
        },
        administration: {
          needleRules: [
            {
      ...
      vivitrol: {
        ...
        knowledge: {
          ...
          technique:
            "Use the supplied needle selected for body habitus and current deep-gluteal administration instructions.",
          preparation:
          ...
          storage: "Use current carton and label storage instructions.",
          staffGuardrail:
            "Do not treat a generic timing calculation as clinical clearance; opioid-risk and contraindication review remain required for each administration.",
        },
        administration: {
          ...
          needleRules: [
            {
              ...
              needle: {
                gauge: "20G",
                length: '2"',
                descriptor: "customized kit needle",
              },
              rationale:
          ...
          siteRestriction: {
            headline:
              "Deep gluteal IM only — never IV, subcutaneous, or into adipose tissue",
            detail:
      ...
      haldol: {
        ...
        catalog: {
          ...
          missedDoseGuidance:
            "Late-dose handling is individualized by the prescriber.",
          siteGuidance: "order-directed",
        },
        knowledge: {
          className: "Typical antipsychotic LAI",
          technique:
            "Deep IM; label specifies a 21-gauge needle and maximum 3 mL per injection site. Actual site/technique follows the active order and local policy.",
          preparation:
            "Ready-to-use solution; inspect for debris, clarity, and the labeled yellow-to-light-amber color before use.",
          storage:
            "Store and protect from light according to the current carton and label.",
          staffGuardrail:
            "Do not imply a gluteal-only or Z-track requirement. Verify initial-dose splitting, exact dose, and technique against the active order.",
        },
        administration: {
          ...
          needleRules: [
            {
              needle: {
                gauge: "21G",
                descriptor: "length per ordered site and depth",
              },
              rationale:
                "The label specifies a 21-gauge needle. Length follows the ordered site and tissue depth.",
            },
          ],
          needleUnresolved: "",
          maxVolumePerSite: {
      ...
      prolixin: {
        ...
        knowledge: {
          className: "Typical antipsychotic LAI",
          technique:
            "IM or subcutaneous administration; use a dry syringe and needle of at least 21 gauge per the current label.",
          preparation:
            "Ready-to-use oil solution; visually inspect when the solution and container permit, and use dry preparation equipment.",
          storage: "Use current carton and label storage instructions.",
          staffGuardrail:
            "Do not invent an anatomical default. Record the actual ordered route/site and follow provider/local technique direction.",
        },
        administration: {
...
export const injectionClinicalPhaseForReason = (
  reason: string,
): InjectionClinicalPhase => {
  switch (reason) {
    case "initiation":
      return "initiation";
    case "reinit":
