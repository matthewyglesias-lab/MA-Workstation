...
assert.match(html, /UDS_PANELS\.forEach\(panel=>\{UDS\.results\[panel\]='nt';\}\);/, 'Selecting or changing a UDS device must leave every panel neutral until staff records the physical readings');
